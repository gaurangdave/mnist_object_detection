...
class YoloObjectDetectionModel(tf.keras.Model):
    def __init__(self, model_architecture, lambdas=None, **kwargs):
        ...
        self.bbox_coordinate_loss_tracker = tf.keras.metrics.Mean(
            name="bbox_coordinate_loss")
        self.bbox_size_loss_tracker = tf.keras.metrics.Mean(
            name="bbox_size_loss")
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            # calculate loss
            loss_dict = training_utils.calculate_yolo_model_loss_dict(
        ...
        self.bbox_coordinate_loss_tracker.update_state(
            loss_dict["bbox_coordinate_loss"])
