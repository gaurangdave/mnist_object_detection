...
class ObjectDetectionModel(tf.keras.Model):
    def __init__(self, model_architecture, **kwargs):
        ...
        self.obj_less_loss_tracker = tf.keras.metrics.Mean(name="obj_less_loss")
    ...
    def from_config(cls, config):
        ...
        model_architecture = tf.keras.utils.deserialize_keras_object(model_arch_config)
        
        # 3. Create and return a new instance of this class,
        #    passing the model to the constructor
        return cls(model_architecture, **config)
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            ## calculate loss
            loss_dict = training_utils.calculate_model_loss_dict(y_true=y_true,y_pred=y_pred)
